...
#..........................import data...........................
mko <- read_csv(here::here("data", "mohawk_mooring_mko_20250117.csv"))
...
mko_clean |> 
  ...
  ggplot(aes(x = Temp_bot, fill = month_name)) + 
  geom_histogram(position = "identity", alpha = 0.5, color = "black", binwidth = 0.1) +
...
ggplot(mko_clean, aes(x = month_name, y = Temp_bot)) +
  geom_violin() +
  geom_boxplot(width = 0.15, fill = "grey", color = "gray30", alpha = 0.5) +
  scale_x_discrete(limits = rev(month.name)) +
  coord_flip()
