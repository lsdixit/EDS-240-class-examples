...
#..........................import data...........................
iwa_data <- read_csv(here::here("data", "combined_iwa-assessment-outputs-conus-2025_CONUS_200910-202009_long.csv"))
...
font_add_google(name = "Noto Sans", family = "nono-sans")
...
# fig asp closer to 1 is longer, closer to 0 is wider
...
annotation <- glue::glue(
  ...
  indicates reliance on groundwater, imported water, or 
  stored reserves."
)
...
water_plot <- ggplot(sbc_subbasin_monthly) +
  ...
  theme(
    ...
    plot.title = ggtext::element_markdown(family = "sarala",
                              ...
                              color = pal["darkgrey"],
                              lineheight = 1.2),
    plot.subtitle = element_text(family = "noto-sanse",
                                 size = rel(0.9),
                                 color = pal["lightgrey"],
                                 margin = margin(b = 8)),
    axis.text = element_text(family = "red",
                             size = rel(0.7),
                             color = pal["lightgrey"]),
    axis.title.x = element_text(family = "noto-sanse",
                                size = rel(0.75),
                                margin = margin(t = 15)),
    axis.title.y = element_blank(),
    plot.caption = ggtext::element_markdown(family = "noto-sanse",
                                face = "italic",
                                size = rel(0.5), 
                                color = pal['lightgrey'],
                                margin = margin(t = 15),
...
ggsave(
  file = here::here("week7", "images", "sbc-hydro-larger.png"),
  plot = water_plot,
  device = "png",
